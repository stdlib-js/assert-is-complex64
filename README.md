...
```javascript
import isComplex64 from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-complex64@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-complex64/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/assert-is-complex64/actions/workflows/test.yml?query=branch:v0.1.1
